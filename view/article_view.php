...
<body>
    ...
    <div class="container" id="container">
        <main>
            ...
            if (!$article) {
                ...
                echo "<p><a href='explore_view.php'>Return to Explore</a></p>";
                exit;
            }

            $formattedDate = formatArticleDate($article['published_at']);
            $readTime = $article['read_time'] ?? 5;
            ?>
            <div class="article-content">
                <a href="explore_view.php"
                    style="color: rgba(255,255,255,0.7); text-decoration: none; display: flex; align-items: center; gap: 0.5rem; margin-bottom: 2rem;">
                ...
                <div class="article-header">
                    ...
                    <div class="article-meta">
                        <span><i class="fas fa-user"></i> By
                            <?= htmlspecialchars($article['author_name'] ?? 'Bubble Team') ?></span>
                        <span><i class="fas fa-calendar"></i> <?= $formattedDate ?></span>
                        <span><i class="fas fa-clock"></i> <?= $readTime ?> min read</span>
                    </div>
                </div>

                <img src="<?= htmlspecialchars($article['banner_image'] ?? '../assets/images/default-article.png') ?>"
                    alt="<?= htmlspecialchars($article['title']) ?>" class="article-banner">

                <div class="article-text">
                    <?= nl2br($article['content']) ?>

                    <!-- Media embed section - Only show if related media exists (Placeholder logic for now) -->
                    <div class="media-embed">
                        <h3>Listen or Watch</h3>
                        <div class="media-content">
                            <!-- Placeholder for related mix -->
                            <div class="mix-container">
                                <button class="btn-play-mix">
                            ...
                            <button onclick="openVideo()" class="btn-video">
                    ...
                    <!-- Additional static content or dynamic related articles could go here -->
    ...
    <div id="video-overlay" style="display:none;">
        <div class="glass-panel overlay-content">
            <button onclick="closeVideo()" class="btn-close-overlay">&times;</button>
            <div class="video-responsive">
                <iframe src="https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=0" title="YouTube video player"
                    frameborder="0"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
            </div>
            <div class="overlay-footer">
                <h2 class="overlay-title">Live Session: Neon Nights</h2>
                <p class="overlay-desc">Exclusive behind the scenes footage of the recording session.</p>
            </div>
        </div>
    </div>
